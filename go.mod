...
require (
	...
	github.com/suyuan32/simple-admin-common v1.6.11
	github.com/suyuan32/simple-admin-core v1.6.11
...
replace github.com/zeromicro/go-zero v1.8.5 => github.com/suyuan32/simple-admin-tools v1.8.6-rc.1
