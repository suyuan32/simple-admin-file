...
require (
	...
	github.com/suyuan32/simple-admin-core v1.7.9
...
require (
	...
	github.com/casbin/ent-adapter v1.3.0 // indirect
...
replace github.com/zeromicro/go-zero v1.9.4 => github.com/suyuan32/simple-admin-tools v1.9.5
