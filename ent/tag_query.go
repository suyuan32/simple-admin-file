...
func (tq *TagQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *File)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(file.FieldID), joinT.C(tag.FilesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(tag.FilesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.FilesPrimaryKey[0]))
...
func (tq *TagQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tag.Table, tag.Columns, sqlgraph.NewFieldSpec(tag.FieldID, field.TypeUint64))
	_spec.From = tq.sql
